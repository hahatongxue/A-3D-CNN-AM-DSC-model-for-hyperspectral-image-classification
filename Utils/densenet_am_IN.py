# -*- coding: utf-8 -*-
"""
Created on Wed Dec 30 20:53:25 2020
...
def ssa_3D(input_sa):
    ...
    ssa_refined = Conv3D(filters=1, kernel_size=(3,3,3), strides=(1,1,1),padding='same',activation='sigmoid', kernel_initializer='he_normal')(concat)
...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs):
        ...
        print('change input shape:', input_shape)#(1,11,11,200)

        # 张量流输入
        input = Input(shape=input_shape)

        # 3D Convolution and pooling
        conv1 = Conv3D(64, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='SAME', kernel_initializer='he_normal',data_format = 'channels_last')(
            input)
        pool1 = MaxPooling3D(pool_size=(3, 3, 3), strides=(2, 2, 2),data_format = 'channels_last')(conv1)
        am1 = ssa_3D(pool1)##new added part
        # Dense Block1
        x = dense_block(am1, 6, name='conv1')
