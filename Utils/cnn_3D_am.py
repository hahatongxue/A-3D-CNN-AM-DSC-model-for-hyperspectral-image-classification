...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs):
        ...
        pool1 = MaxPooling3D(pool_size=(2, 2, 2), strides=(1, 1, 1), padding='same')(act1)#padding=same时，尺寸与kernelsize无关
        am1 = ssa_3D(pool1)  #注意力模块
        
        conv2 = Conv3D(filters=192, kernel_size=(3, 3, 3), strides=(1, 1, 2),
...
def main():
    model = ResnetBuilder.build_resnet_8((1, 7, 7, 15), 16)
